                        ...
                        <div class="row g-3">
                            <div class="col-6 align-self-center">
                                <div class="mx-mobile-brand">
                                    <img src="{{ asset('assets/img/logo-w.png') }}" alt="Adminage"
                                                    ...
                                                    <div class="cards t-bg-white t-shadow h-100 p-4 d-flex">
                                                        <div class="mx-kanban-card align-self-center">
                                                            <div class="mx-kanban-card__header d-flex">
                                                                <div
                                                                    class="mx-box mx-box--round mx-box--md mx-box--light-primary t-mr-8">
                                                                ...
                                                                <div class="mx-kanban-card__header-content">
                                                                    <span class="d-block xsm-text text-capitalize">react
                                                                        dev</span>
                                                                    <span
                                                                        class="d-block text-capitalize fw-bold lg-text">New
                                                            ...
                                                            <div class="mx-kanban-card__footer">
                                                                <ul class="t-list avatars__group avatars__group--md">
                                                                    <li>
                                                                        <a href="#" class="t-link">
                                                                            <div
                                                                                class="avatars avatars--circle avatars--sm-plus">
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody class="t-mt-15">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-transparent btn-success xsm-text">Success</button>
                                                                        </td>
                                                                        <td
                                                                            class="text-center text-capitalize text-primary font-weight-bold xsm-text">
                                                                            retail</td>
                                                                        <td>
                                                                            <div class="dropdown ">
                                                                                <button
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            class="text-center text-capitalize text-secondary font-weight-bold xsm-text">
                                                                            retail</td>
                                                                        <td>
                                                                            <div class="dropdown ">
                                                                                <button
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-transparent btn-warning xsm-text text-capitalize">warning</button>
                                                                        </td>
                                                                        <td
                                                                            class="text-center text-capitalize text-success font-weight-bold xsm-text">
                                                                            retail</td>
                                                                        <td>
                                                                            <div class="dropdown ">
                                                                                <button
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div
                                                                                class="messages__msg justify-content-center t-width-max">
                                                                                <div
                                                                                    class="messages__avatar messages__avatar-empty t-bg-epsilon">
                                                                                    <div
                                                                                        class="messages__avatar-replacer text-uppercase">
                                                                                        as
                                                                                    </div>
                                                                        ...
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-transparent btn-danger xsm-text text-capitalize">danger</button>
                                                                        </td>
                                                                        <td
                                                                            class="text-center text-capitalize text-danger font-weight-bold xsm-text">
                                                                            retail</td>
                                                                        <td>
                                                                            <div class="dropdown ">
                                                                                <button
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-transparent btn-primary xsm-text text-capitalize">danger</button>
                                                                        </td>
                                                                        <td
                                                                            class="text-center text-capitalize text-warning font-weight-bold xsm-text">
                                                                            retail</td>
                                                                        <td>
                                                                            <div class="dropdown ">
                                                                                <button
                                                    ...
                                                    <div class="cards t-bg-white t-shadow h-100">
                                                        <div
                                                            ...
                                                            <ul class="t-list d-flex flex-wrap align-items-center">
                                                                <li class="t-list__item">
                                                                    <a href="#"
                                                                        class="t-link t-link--primary font-weight-md text-capitalize sm-text active">today</a>
                                                                </li>
                                                                <li class="t-list__item">
                                                                    <a href="#"
                                                                        class="t-link t-link--primary font-weight-md text-capitalize sm-text">week</a>
                                                                </li>
                                                                <li class="t-list__item">
                                                                    <a href="#"
                                                                        class="t-link t-link--primary font-weight-md text-capitalize sm-text">month</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                                ...
                                                                <li class="mb-3">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="avatars avatars--rounded avatars--sm-plus t-mr-8">
                                                                                <img src="{{ asset('assets/img/overlay-1.jpg') }}"
                                                                                    alt="max" class="img-fulid w-100">
                                                                            </div>
                                                                            <div
                                                                                class="messages__content messages__content--unseen">
                                                                ...
                                                                <li class="mb-0">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="avatars avatars--rounded avatars--sm-plus t-mr-8">
                                                                                <img src="{{ asset('assets/img/overlay-3.jpg') }}"
                                                                                    alt="max" class="img-fulid w-100">
                                                                            </div>
                                                                            <div
                                                                                class="messages__content messages__content--unseen">
